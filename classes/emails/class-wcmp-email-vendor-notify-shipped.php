...
class WC_Email_Notify_Shipped extends WC_Email {
	...
	function __construct() {
		...
		$this->title 			= __( 'Notify as Shipped.', $WCMp->text_domain );
		$this->description		= __( 'Confirm customer that vendor has shipped the order.', $WCMp->text_domain );

		$this->template_html 	= 'emails/vendor-notify-shipped.php';
		$this->template_plain 	= 'emails/plain/vendor-notify-shipped.php';

		$this->subject 			= __( 'Your Order on {site_title} has been Shipped', $WCMp->text_domain);
