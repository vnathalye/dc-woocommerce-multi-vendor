...
if (!class_exists('WC_Email_Admin_New_Vendor_Account')) :
    ...
    class WC_Email_Admin_New_Vendor_Account extends WC_Email {
        ...
        public function get_default_subject() {
            return apply_filters('wcmp_admin_new_vendor_email_subject', __('[{site_title}] New Vendor Account', 'dc-woocommerce-multi-vendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('wcmp_admin_new_vendor_email_heading', __('New Vendor Account', 'dc-woocommerce-multi-vendor'), $this->object);
        }
