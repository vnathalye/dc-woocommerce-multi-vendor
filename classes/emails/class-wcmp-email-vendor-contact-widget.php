...
class WC_Email_Vendor_Contact_Widget extends WC_Email {
    ...
    public function get_default_subject() {
        ...
        return apply_filters( 'wcmp_vendor_contact_widget_email_subject', $subject, $this->object );
    }
    ...
    public function get_default_heading() {
        return apply_filters( 'wcmp_vendor_contact_widget_email_heading', __( "{STORE_NAME}'s Customer contact", 'dc-woocommerce-multi-vendor'), $this->object );
    }
    ...
    public function get_headers() {
        ...
        if( apply_filters( 'wcmp_vendor_contact_widget_email_goes_to_admin', true, $this->object ) ) {
        ...
        return apply_filters( 'wcmp_vendor_contact_widget_email_headers', $header, $this->id, $this->object );
    }
