...
class DC_Widget_Vendor_Info extends WP_Widget {
  ...
  function DC_Widget_Vendor_Info() {
  	...
  	$this->widget_idbase = 'dc_product_vendors_info';
		$this->widget_title = __( "WCMp Product Vendor's Info", $WCMp->text_domain );
		$this->widget_cssclass = 'widget_product_vendor_info';
		$this->widget_description = __( 'Display selected or current product vendor info.', $WCMp->text_domain );
  ...
  /**
	...
	*/
	public function form( $instance ) {
		...
		<span class="description"><?php _e('This widget shows..',  $WCMp->text_domain) ?> </span>
		<?php
	}
}