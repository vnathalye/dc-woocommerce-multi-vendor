                ...
                "products_capability" => array(
                  "title" => __('Products Capability', $WCMp->text_domain),
                    "fields" => array(
                        ...
                        "is_edit_delete_published_product" => array('title' => __('Edit Publish Products', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_edit_delete_published_product', 'label_for' => 'is_edit_delete_published_product', 'name' => 'is_edit_delete_published_product', 'desc' => __('Allow vendors to Edid published products.', $WCMp->text_domain), 'value' => 'Enable'), // Checkbox
                        ...
                        "is_edit_delete_published_coupon" => array('title' => __('Edit Publish Coupons', $WCMp->text_domain), 'type' => 'checkbox', 'id' => 'is_edit_delete_published_coupon', 'label_for' => 'is_edit_delete_published_coupon', 'name' => 'is_edit_delete_published_coupon', 'desc' => __('Allow Vendor To edit delete published shop coupons.', $WCMp->text_domain), 'value' => 'Enable'), // Checkbox
