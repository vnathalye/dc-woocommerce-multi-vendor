...
<div id="wcmp_customer_qna" class="woocommerce-wcmp_customer_qna">
    <div id="cust_qna_form_wrapper">
        <div id="cust_qna_form">
            <h2 id="custqna-title" class="custqna-title"><?php echo apply_filters('wcmp_customer_qna_label', __('Questions and Answers', 'dc-woocommerce-multi-vendor'));?></h2>			
                ...
                <form action="" method="post" id="customerqnaform" class="customerqna-form" novalidate="">
                    ...
                    <div id="qna-ask-input">
                        ...
                        <div id="ask-wrap">
                            ...
                            <button id="ask-qna" class="btn btn-info btn-lg" type="button"><?php _e('Ask Now', 'dc-woocommerce-multi-vendor');?></button>
                        </div>
                    ...
                    <div class="qna-block">
                        ...
                        <div class="qna-vote">
                            ...
                            if(is_user_logged_in()){ ?>
                                ...
                                <a href="javascript:void(0)" title="<?php _e('You already gave a thumbs up.', 'dc-woocommerce-multi-vendor');?>" class="give-up-vote" data-vote="up" data-ans="<?php echo $qna->ans_ID; ?>"><i class="vote-sprite vote-sprite-like"></i></a>
                                <span class="vote-count"><?php echo $count; ?></span>
                                <a href="" title="<?php _e('Give a thumbs down', 'dc-woocommerce-multi-vendor');?>" class="give-vote-btn give-down-vote" data-vote="down" data-ans="<?php echo $qna->ans_ID; ?>"><i class="vote-sprite vote-sprite-dislike"></i></a>
                                    <?php }else{ ?>
                                <a href="" title="<?php _e('Give a thumbs up', 'dc-woocommerce-multi-vendor');?>" class="give-vote-btn give-up-vote" data-vote="up" data-ans="<?php echo $qna->ans_ID; ?>"><i class="vote-sprite vote-sprite-like"></i></a>
                                <span class="vote-count"><?php echo $count; ?></span>
                                <a href="javascript:void(0)" title="<?php _e('You already gave a thumbs down.', 'dc-woocommerce-multi-vendor');?>" class="give-down-vote" data-vote="down" data-ans="<?php echo $qna->ans_ID; ?>"><i class="vote-sprite vote-sprite-dislike"></i></a>
                                    <?php } 
                                }else{ ?>
                                <a href="" title="<?php _e('Give a thumbs up', 'dc-woocommerce-multi-vendor');?>" class="give-vote-btn give-up-vote" data-vote="up" data-ans="<?php echo $qna->ans_ID; ?>"><i class="vote-sprite vote-sprite-like"></i></a>
                                <span class="vote-count"><?php echo $count; ?></span>
            ...
            <?php }
                if(count($cust_qna_data) > 4){
                    echo '<div class="qna-item-wrap load-more-qna"><a href="" class="load-more-btn button" style="width:100%;text-align:center;">'.__('Load More', 'dc-woocommerce-multi-vendor').'</a></div>';
                }
            }
            ?>
            </div>
