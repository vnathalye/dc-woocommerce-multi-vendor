...
//            }
            wcmp_media_frame = new media.view.WCMpCropperFrame({
                cropOptions: {
                    maxWidth: target == "vendor-cover" ? frontend_dash_upload_script_params.cover_ratio[0] : 100, //target width
                    maxHeight: target == "vendor-cover" ? frontend_dash_upload_script_params.cover_ratio[1] : 100 // target height
                },
                canSkipCrop: true,
