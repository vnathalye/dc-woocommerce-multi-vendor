	...
	public static function output( $attr ) {
		...
		<div class="wcmp_remove_div">
			<div class="wcmp_main_page">  <?php 
				$WCMp->template->get_template( 'vendor_dashboard_menu.php' , array('selected_item' => 'policies'));
				$WCMp->template->get_template( 'shortcode/vendor_policy.php', $user_array);
				?>
			</div>
		</div>
		<?php
