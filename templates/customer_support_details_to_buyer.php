	...
	<tbody>
		...
		if( isset( $capability_settings['can_vendor_add_customer_support_details'] ) ) {
			foreach ( $vendor_array as $vendor_id => $products) { 
				...
				<?php if($cc == 0) { ?>
					<tr>
					<th style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:100%;" align="left" valign="top"><?php echo __('Vendor Details', $WCMp->text_domain); ?></th>
				...
				<tr>
					<td style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:100%;" align="left" valign="top">
						...
						<p><strong><?php echo __('Email : ',$WCMp->text_domain);?></strong><br>
						...
						<p><strong><?php echo __('Phone : ',$WCMp->text_domain); ?></strong> <br>
						<?php echo $vendor_meta['_vendor_customer_phone'][0]; ?></p>
						<?php }?>
						<p><strong><?php echo __('Return Address ', $WCMp->text_domain);?></strong></p>
						<p>
			...
			?>
			<tr>
					<th style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:100%;" align="left" valign="top"><?php echo __('Customer Support Details & Product Return Address', $WCMp->text_domain); ?></th>
