 ...
 *
 * Override this template by copying it to yourtheme/dc-product-vendor/shortcode/vendor_announcements.php
 *
 * @author 		dualcube
...
<div class="wcmp_main_holder toside_fix">
	<div class="wcmp_headding1">
		<ul>
			<li><?php _e('Announcements',$WCMp->text_domain); ?></li>
		</ul>
		<div class="clear"></div>
	</div>
	<div id = "tabs-1">
		...
		<div id = "wcmp_msg_tab_1" data-element="_all">
			...
			<div class="msg_container" >			
				<?php							
					//show all messages
					$WCMp->template->get_template( 'shortcode/vendor_announcements_all.php');
				?>			
			</div>
		</div>
		<!--...................... end of tab1 .......................... -->
		...
		<div id = "wcmp_msg_tab_2" data-element="_read">
			...
			<div class="msg_container" >							
				<?php							
					//show read messages
					$WCMp->template->get_template( 'shortcode/vendor_announcements_read.php');
				?>			
			</div>
		</div>
		<!--...................... end of tab2 .......................... -->
		...
		<div id = "wcmp_msg_tab_3" data-element="_unread">
			...
			<div class="msg_container" >				
				<?php							
					...
					$WCMp->template->get_template( 'shortcode/vendor_announcements_unread.php');
				?>				
			</div>
		</div>
		<!--...................... end of tab3 .......................... -->
		...
		<div id = "wcmp_msg_tab_4" data-element="_archive">
			...
			<div class="msg_container">				
				<?php							
					//show unread messages
					$WCMp->template->get_template( 'shortcode/vendor_announcements_archive.php');
				?>				
			</div>
		</div>
		<!--...................... end of tab4 .......................... -->
