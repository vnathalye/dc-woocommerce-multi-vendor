            ...
            <div>
                ...
                $WCMp->wcmp_frontend_fields->wcmp_generate_form_field(array(
                    "attributes" => array('label' => __('Attributes', 'dc-woocommerce-multi-vendor'), 'type' => 'multiinput', 'class' => 'regular-text pro_ele simple variable external grouped', 'label_class' => 'pro_title', 'value' => $attributes, 'options' => array(
                            ...
                            "value" => array('label' => __('Value(s):', 'dc-woocommerce-multi-vendor'), 'type' => 'textarea', 'class' => 'regular-textarea pro_ele simple variable external grouped', 'placeholder' => __('Enter some text, some attributes by "|" separating values.', 'dc-woocommerce-multi-vendor'), 'label_class' => 'pro_title'),
...
<!--                <p class="upsell_ids pro_ele pro_title simple variable external grouped"><strong><?php _e('Up-sells', 'dc-woocommerce-multi-vendor'); ?></strong><span class="img_tip" data-desc="Up-sells are products which you recommend instead of the currently viewed product, for example, products that are more profitable or better quality or more expensive."></span></p>-->
                <label class="control-label form-label col-sm-3" for="upsell_ids"><?php _e('Up-sells', 'dc-woocommerce-multi-vendor'); ?><span class="img_tip" data-desc="Up-sells are products which you recommend instead of the currently viewed product, for example, products that are more profitable or better quality or more expensive."></span></label>
                <div class="col-md-6 col-sm-9">
            ...
            <!--<p class="crosssell_ids pro_ele pro_title simple variable external grouped"><strong><?php _e('Cross-sells', 'dc-woocommerce-multi-vendor'); ?></strong><span class="img_tip" data-desc="Cross-sells are products which you promote in the cart, based on the current product."></span></p>-->
                <label class="control-label form-label col-sm-3" for="crosssell_ids"><?php _e('Cross-sells', 'dc-woocommerce-multi-vendor'); ?><span class="img_tip" data-desc="Cross-sells are products which you promote in the cart, based on the current product."></span></label>
                <div class="col-md-6 col-sm-9">
