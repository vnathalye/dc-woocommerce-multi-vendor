...
class WC_Email_Vendor_Direct_Bank extends WC_Email {
	...
	function __construct() {
		...
		$this->title 			= __( 'Commission Paid (for Vendor) by BAC', $WCMp->text_domain );
		$this->description		= __( 'New commissions withdrawal request have been submitted by vendor.', $WCMp->text_domain);

		$this->heading 			= __( 'Vendor\'s Commission Requests', $WCMp->text_domain);
		$this->subject      	= __( '[{site_title}] Commission Payment Request', $WCMp->text_domain);
