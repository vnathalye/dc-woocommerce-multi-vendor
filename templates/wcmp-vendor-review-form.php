	...
	<div id="review_form_wrapper">
		<div id="review_form">
			<div id="respond" class="comment-respond">
				<h3 id="reply-title" class="comment-reply-title"><?php if( $count == 0 ) { echo __(sprintf('Be the first to review “%s”',$shop_name),$WCMp->text_domain); }else { echo __(sprintf('Add a review “%s”',$shop_name),$WCMp->text_domain); } ?> </h3>				
