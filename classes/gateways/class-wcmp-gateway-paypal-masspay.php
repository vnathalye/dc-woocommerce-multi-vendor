...
class WCMp_Gateway_Paypal_Masspay extends WCMp_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->api_password = get_wcmp_vendor_settings('api_pass', 'payment', 'paypal_masspay');
        $this->api_signature = get_wcmp_vendor_settings('api_signature', 'payment', 'paypal_masspay');
