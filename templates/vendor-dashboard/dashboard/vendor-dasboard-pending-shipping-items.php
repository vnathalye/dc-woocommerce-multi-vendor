...
if(!empty($product_name)){
    foreach ($product_name as $order_id => $line_product_name){
        ...
        <tr>
           ...
           <td align="left" ><?php echo $order->get_shipping_address_1(); ?> <?php if($order->get_shipping_address_2() != null){echo ",".$order->get_shipping_address_2();} ?> <br>
           <?php echo $order->get_shipping_city(); ?> <?php if($order->get_shipping_state() != null){echo ",".$order->get_shipping_state();} ?> <br/> <?php echo $order->get_shipping_postcode(); ?> <?php if($order->get_shipping_country() != null){echo ",".$order->get_shipping_country();} ?></td>
