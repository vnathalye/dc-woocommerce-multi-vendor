						...
						<div class="wcmp_table_holder">
							<table width="100%" border="0" cellspacing="0" class="wcmp_order_all_table" cellpadding="0">
								<tr>
									...
									<td align="center" class="no_display"  valign="top" > <?php _e( 'Earnings', $WCMp->text_domain );?> </td>
									<td align="center" class="no_display" valign="top"  > <?php _e( 'Status', $WCMp->text_domain );?> </td>
