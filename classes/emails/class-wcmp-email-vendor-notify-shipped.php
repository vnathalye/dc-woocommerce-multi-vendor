...
if (!class_exists('WC_Email_Notify_Shipped')) :
    ...
    class WC_Email_Notify_Shipped extends WC_Email {
        ...
        public function get_default_subject() {
            return apply_filters('wcmp_notify_shipped_email_subject', __('Your Order on {site_title} has been Shipped', 'dc-woocommerce-multi-vendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('wcmp_notify_shipped_email_heading', __('Welcome to {site_title}', 'dc-woocommerce-multi-vendor'), $this->object);
        }
