...
if (!class_exists('WC_Email_Admin_Added_New_Product_to_Vendor')) :
    ...
    class WC_Email_Admin_Added_New_Product_to_Vendor extends WC_Email {
        ...
        public function get_default_heading() {
            return apply_filters('wcmp_admin_added_new_product_to_vendor_email_heading', __('New product submitted: {product_name}', 'dc-woocommerce-multi-vendor'), $this->object);
        }
