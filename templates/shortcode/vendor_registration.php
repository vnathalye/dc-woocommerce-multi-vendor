        ...
        <div class="wcmp_regi_form_box">
            ...
            <?php if ('no' === get_option('woocommerce_registration_generate_username')) : ?>
                <div class="wcmp-regi-12">
                    <label for="reg_username"><?php _e('Username', 'dc-woocommerce-multi-vendor'); ?> <span class="required">*</span></label>
            ...
            <?php endif; ?>
            <div class="wcmp-regi-12">
                <label for="reg_email"><?php _e('Email address', 'dc-woocommerce-multi-vendor'); ?> <span class="required">*</span></label>
            ...
            <?php if ('no' === get_option('woocommerce_registration_generate_password')) : ?>
                <div class="wcmp-regi-12">
                    <label for="reg_password"><?php _e('Password', 'dc-woocommerce-multi-vendor'); ?> <span class="required">*</span></label>
                    <input type="password" required="required" name="password" id="reg_password" />
                </div>
            <?php endif; ?>
            <div style="<?php echo ( ( is_rtl() ) ? 'right' : 'left' ); ?>: -999em; position: absolute;"><label for="trap"><?php _e('Anti-spam', 'dc-woocommerce-multi-vendor'); ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>
