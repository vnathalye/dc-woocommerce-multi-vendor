...
if(!empty($pro_id)){
    ...
    if (is_user_logged_in() && is_user_wcmp_vendor($current_vendor_id) && !current_user_can('edit_published_products') && !in_array($product->get_status(), apply_filters('wcmp_enable_edit_product_options_for_statuses',array('draft', 'pending')))) {
        ?>
        <div class="col-md-12">
            <div class="panel panel-default">
