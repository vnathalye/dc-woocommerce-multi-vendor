...
class WC_Email_Vendor_Commission_Transactions extends WC_Email {
	...
	function __construct() {
		...
		$this->heading 			= __( ' Transaction Details', $WCMp->text_domain);
		$this->subject      	= __( '[{site_title}] The transaction you requested was successfully completed.', $WCMp->text_domain);
